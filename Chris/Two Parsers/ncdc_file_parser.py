###==================KALEB NOTES:==============================================
#    LINE 291=data = np.asarray(datal,dtype=np.float64)- I GET: ValueError: could not convert string to float: age_AD
#        MAKING THE LINE= data = np.asarray(datal) WORKS JUST FINE, NO NEED TO FLOAT THAT I COULD FIND
#    LINE 347= THE VARIABLE DESCRIPTOR "ERROR" DNE "UNCERTAINTY". "ERROR" IS A SPECIFIC TERM FOR DOCUMENTING WHETHER THERE IS AN ERROR IN THE DATA OF THAT VARIABLE, NOT THE DATA'S UNCERTAINTY
...
def ncdc_file_parser(filename):
    ...
    try:
        ...
        d['TimeUnit']             = colonReader('time_unit', fCon, fCon_low, '\n')
    ...
    data = np.asarray(datal,dtype=np.float64)
