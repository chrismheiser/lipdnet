...
def parser():
    ...
    try:
        answer = input("Are your files stored in the current directory? (y/n)")
        print("\n")
    except EOFError:
        return
    ...
    for current_file in excel_files:
        ...
        while data_qc.cell_value(rowCellVars, 0) != 'Data' and data_qc.cell_value(rowCellVars,0) != '':
            ...
            for i in attrCols:
                try:
                    if data_qc.cell_value(rowCellVars, i) != "N/A" and data_qc.cell_value(rowCellVars, i) != "":
                        ...
                        ## Insert the variable into the attributes dictionary
            ...
            dataList = []
            try:
                while data_qc.cell_value(rowCellData, colCellData) != xlrd.empty_cell:
        ...
        file_csv = ('output/' + new_file_name_csv)
        ...
        for i in range(0, end_col):
            if data_qc.cell_value(i, 0) == 'Data':
                start_row = i + 3
