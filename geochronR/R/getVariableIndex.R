getVariableIndex = function(table,varName,altNames=varName,ignore=NA,always.choose=FALSE){
#restrict to lists  
...
#  cat(paste0("No variable called ", varName, "\n"))
  ...
  if(length(idi)==0){
    ...
    cat(paste("Use",cnames[idi], "instead?"), "\n")
