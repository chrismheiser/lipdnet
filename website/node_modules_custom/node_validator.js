  ...
  return {
    ...
    processData: (function(files, options, cb){
      ...
      var standardized_keys = {
        ...
        "paleoData_variableName": ["Ti", "Mo", "material", "brGDGT-IIIc5me", "flood", "d15N", "TIC", "relativeHumidity", "lakeVolume", "bulkDensity", "Oliverid", "C37:3aAlkenone", "d13C", "Picea/Pinus", "V humeralis", "deleteThisColumn", "brGDGT-IIIb5me", "Mn/Fe", "Cricotop", "C20n-alkanoicAcid", "lakeArea", "treeCover", "pollenSum", "Corynone", "duration", "LDI", "Cr", "growing degree days", "Paraclad", "Uk37", "V", "Delphineis", "wetBulkDensity", "Percent_fine_fraction", "Y", "Pollen_trees+shrubs", "AET/PET", "BorealTrees", "Cyperaceae", "Compositae", "BIT", "event", "Pb", "brGDGT-IIIb6me", "Pinyon", "brGDGT-Ic", "CaO", "epsilonC28C22", "Artemesia/Ambrosia", "RAN15", "Al", "dolomite", "Fe/Al", "waterContent", "pollen_grains/gram", "Paralia_sucata", "hemidiscusCuneiformis", "pH", "cluster", "sequence", "A. octonarius", "Pseudoeunotia_doliolus", "chloride", "actinocyclusCurvatulus", "F_curta_gp", "K37", "ElNinoEvent", "needsToBeChanged", "deltaTemperature", "BorealShrubs", "La", "T_oestrupii", "ReticyprisSp", "thickness", "foraminifera", "ARM/IRM", "Tsuga_heterophylla", "Poaceae/Ephedra", "amps", "Octactis_pulchra_(lrg)", "Compositeae", "Ca/K", "P. nitidum", "Cl", "Zalutsch", "Sequoia", "brGDGT-IIa6me", "Eu/Zr", "Psectroc", "Dd2H", "Thalassiothrix_longissima", "PC1", "diatom", "carbon", "Mn/Ti", "Procladi", "Stephanopyxis_spp.", "N_sicula", "Coscinodiscus_radiatus", "nitrogen", "accumulation", "age", "equilibriumLineAltitude", "pyrite", "Pollen_fern_spores", "PC2", "Ti/Al", "ARSTAN", "Fe/Mn", "Az. tabularis", "pollen_count", "conc_dino", "landscapeCover", "C37:2Alkenone", "MXD", "ringWidth", "GDGT", "Al2O3", "oxygen", "segmentLength", "streamflow", "T_pacifica", "year", "dryBulkDensity", "uncertaintyHigh95", "D_calida_ampliata", "Si/Al", "uncertaintyLow90", "Mg/Ca", "C23n-alkanoicAcid", "clay", "isReliable", "pollen_sequence", "Quercus", "notes", "Poaceae", "Npachderma", "Chenopodiacaeae", "C/N", "Dictyocha_acueata", "K/Al", "Pollen_conc", "hasGap", "seaIce", "Be", "CCA2", "grainSize", "T_mertensianna", "MgO", "C24n-alkanoicAcid", "epsilonC28C24", "GDGT-0/Cren", "Ba", "brGDGT-IIb6me", "sedimentationRate", "Picea/Artemisia", "brGDGT-IIa5me", "EPS", "hasHiatus", "Pinus/Artemesia", "effectivePrecipitation", "deltaRelativeHumidity", "Br", "uncertainty2s", "actinoptychus", "Foraminifera", "dinocyst", "section", "Cd", "sulfur", "Chaoboru", "Cd/Mn", "depth", "C37Alkenone", "NO3", "MS", "quartz", "sampleID", "correction", "volume", "layerThickness", "zscore", "Al/Si", "Rb87/Sr86", "PollenConc", "ReticyprisHerbstii", "RABD660670", "alnus", "azpeitiaNodulifer", "C27n-alkanoicAcid", "Thronshrub", "count", "Pentaneu", "Fe/Ca", "BSi", "Thalassiosira_excentrica", "Other_planktic", "Mn", "O_pulchra_(small)", "Actinoptychus spp.", "ArtemesiaChenopodiumSar", "calcificationRate", "totalCarbon", "residualChronology", "dust", "eventLayer", "Sr", "AustralocyprisRobusta", "Ba/Al", "concentration", "uncertainty", "Ailanthus", "waterTableDepth", "feldspar", "Dc_stapedia_aspinosa", "Stictoch", "Ba/Sr", "Si", "uncertaintyLow", "uranium", "elevation", "Score_Steppe", "D_stapedia", "TOC/TN", "euplank", "aquaticPollen", "ArtemisiaCount", "phosphorus", "quercus_juniperus_cercocarpus", "Inaperturate", "d2HUncertaintyHigh80", "Artemisia", "growthRate", "density", "Anadenanthera", "uncertaintyHigh", "brGDGT-IIc6me", "Sc", "Stephanopyxis", "Juyanze", "DiacyprisCompacta", "mineralogy", "C37:3bAlkenone", "D_aff_D_aculeata", "uncertainty1s", "Heterotr", "Ba/Ca", "10Be", "iceMelt", "Roperia_tesselata", "uncertaintyHigh90", "brGDGT-IIb5me", "C25n-alkanoicAcid", "d18O", "brGDGT-Id", "Na2O", "organicMatter", "C31n-alkanoicAcid", "productivity", "Azpeitia nodulifer", "pachysin", "Cu", "pollen", "index", "Uk37", "reflectance", "UK37", "TDS", "PinusEdulisCount", "Freshwater_planktic", "Ti/Ca", "V/Al", "varveThickness", "Score_Taiga", "depthTop", "Pine", "Paq", "PiceaCount", "percent", "aragonite", "R650/R700", "Chenopodiaceae", "d2HUncertaintyLow80", "circulationIndex", "brGDGT-IIc5me", "herbs", "D_calida", "A. tabularis", "C21n-alkanoicAcid", "RBAR", "Coscinodiscus_spp.", "potassium", "grayscale", "abies", "nitrate", "ACL", "Ca/Mg", "DWHI", "salinity", "age14C", "Thalassiosira spp.", "latitude", "CCA1", "Ca", "C28n-alkanoicAcid", "chironomid", "charcoal", "facies", "Rb", "brGDGT-IIIa5me", "Co", "Ca/Ti", "gamma", "sodium", "deuteriumExcess", "totalPollen", "Pollen_indet", "Ca/Sr", "bubbleNumberDensity", "peat", "Sr/Ca", "Zr/Al", "Score_Tundra", "sand", "correlationCoefficient", "inc/coh", "Pseudtsuga", "Pinus", "Chironomid_C", "Cyclotella_spp.", "Sergenti", "Pinus/Artemisia", "Fragilariopsis", "acinocyclus.Curvatulus", "brGDGT-Ib", "Artemesia", "As", "lithics", "ammonium", "temperature", "core", "uncertaintyLow1s", "CBT", "fluorine", "solarIrradiance", "O_pulchra_(med)", "hygrophytes", "N/C", "epsilonC29C23", "Tanytars", "siteCount", "longitude", "Picea", "lakeLevel", "Ni", "Pollen_sequence", "Mg", "MAR", "R570/R630", "NeedleleavedWoodyCover", "SO4", "needsToBeSplitIntoMultipleColumns", "SSS", "actinocyclusOctonarius", "brGDGT-IIIa6me", "IP25", "sedimentDry", "glacierCoverage", "Rhizosolenia", "uncertaintyHigh1s", "brGDGT-Ia", "Mn/Mo", "hole", "Neodenticula_seminae", "C25_2n-alkanoicAcid", "C29n-alkanoicAcid", "MBT", "Fe", "D_perlaevis", "boron", "IRM", "tycho", "Chaetoceros spores", "Pollen_spores_Total", "Gramineae", "Paralia sulcata", "C30n-alkanoicAcid", "PinusTotalCount", "brGDGT-IIIc6me", "ash", "d2H", "carbonate", "Fe/K", "CPI", "globigerinoidesRuber", "PC3", "TEX86", "Zr", "Actinoptychus_and_Paralia", "PiceaPinus", "Ephedra", "JulianDay", "precipitation", "T_spp", "iceRaftedDebris", "Coscinodiscus_large", "Zn", "ITCZ", "chlorin", "O_pulchra_(thick)", "uncertaintyHigh50", "K2O", "Pollen_herbs", "MytilocyprisPraenuncia", "Eukieffe", "totalNitrogen", "organicCarbon", "TiO2", "composite", "D_aspinosa", "humidificationIndex", "silt", "site", "uncertaintyLow95", "CaCO3", "sulfate", "LOI", "MnO", "C26n-alkanoicAcid", "Fe2O3", "Misodendron", "organicNitrogen", "Si/Ti", "Pseudodi", "upwelling", "Fir", "diatomCount", "C37:4Alkenone", "sampleCount", "broadleavedWoodyCover", "C22n-alkanoicAcid", "lakeTrend", "calcite", "Chaetoceros_spores", "Nitzschia_interruptestriata", "depthBottom"]
      };
